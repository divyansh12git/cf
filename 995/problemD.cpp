...
void solve(){
    ...
    fl(i,0,n-1){
        ...
        ll u=tot-x;
        // cerr<<l<<" "<<u<<endl;
        // cout<<bs1(a,i+1,n-1,l)<<" ";
        // cout<<bs2(a,i+1,n-1,u)<<endl;
        // int p=bs1(a,i+1,n-1,l);
        // int q=bs2(a,i+1,n-1,u);
        // if(p==-1 || q==-1 || p>q){
        //     continue;
        // }
        auto lb=lower_bound(a.begin()+i+1,a.end(),l);
        auto ub=upper_bound(a.begin()+1+i,a.end(),u);
        int p=lb-a.begin();
        int q=ub-a.begin()-1;
        // cerr<<p<<" "<<q<<" "<<a[i]<<endl;
