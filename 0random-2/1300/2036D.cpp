...
void divyansh_8(){
    ...
    string mat="1543";
    ll ans=0;
    auto tr=[&](int &curr,bool se){
        fl(c,c1,c2){
            // cerr<<car[r1][c]<<" ";
            if(car[r1][c]==mat[curr]){
                curr++;
            }else{
                if(car[r1][c]=='1')curr=1;
                else curr=0;
                if(se)return;
            }
            if(curr==4){
        ...
        fl(r,r1,r2){
            // cerr<<car[r][c2]<< " ";
            if(car[r][c2]==mat[curr]){
                curr++;
            }else{
                if(car[r][c2]=='1')curr=1;
                else curr=0;
                if(se)return;
            }
            if(curr==4){
        ...
        frl(c,c2,c1+1){
            // cerr<<car[r2][c]<< " ";
            if(car[r2][c]==mat[curr]){
                curr++;
            }else{
                if(car[r2][c]=='1')curr=1;
                else curr=0;
                if(se)return;
            }
            if(curr==4){
        ...
        frl(r,r2,r1+1){
            // cerr<<car[r][c1]<<" ";
            if(car[r][c1]==mat[curr]){
                curr++;
            }else{
                if(car[r][c1]=='1')curr=1;
                else curr=0;
                if(se)return;
            }
            if(curr==4){
    ...
    while(r1<r2 && c1<c2){
        ...
        tr(curr,0);
        // cerr<<curr<<endl;
        if(curr>0 && ((car[r1][c1]!='1')))tr(curr,1);
        r1++;r2--;c1++;c2--;
    }
    cout<<ans<<endl;
}
